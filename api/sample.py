...
apiKey = "d25c2d92c9530ff5f7abdf563915555c"
ticker = "WMT"
...
q_result = q_cash_flow_statement.iloc[:,4:].head()

f1.write(q_result.to_string())
f1.close()
...
result = cash_flow_statement.iloc[:,4:].head()

f2.write(result.to_string())
f2.close()
